...
let
  ...
  openjdk = stdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      owner = "openjdk";
      repo = "jdk${version.feature}";
      rev = "jdk-${version.feature}${version.interim}+${version.build}";
      hash = "sha256-NwUSWSLIyMLFzY0pJsUil9/C0O2QHbZuAw+GQETCJhI=";
    };
    ...
    configureFlags = [
      "--with-boot-jdk=${openjdk20-bootstrap.home}"
    ...
    disallowedReferences = [ openjdk20-bootstrap ];
